...
If you are using the repository `Makefile` workflow, remember that `/opt/wg-easy/docker-compose.yml` is generated by `make config` and may be overwritten on the next render.
