...
If you are using the repository `Makefile` workflow, remember that `/opt/wg-easy/docker-compose.yml` is generated by `make config` and will be overwritten on the next render unless you also preserve your changes in the source deployment files.
